...
pm2 ls                      # 即 pm2 list , 列表 PM2 启动的所有的应用程序
...
pm2 delete [app-name]          # 关闭并删除指定应用程序
...
[官方文档](https://pm2.keymetrics.io/docs/usage/application-declaration/#attributes-available)
